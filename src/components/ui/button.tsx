...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-normal ring-offset-background transition-all duration-[400ms] ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        primary:
          "font-space-grotesk bg-[#5f51ff] text-white hover:bg-[#4a3fcc] shadow-button rounded-sm",
        "outline-transparent-primary":
          "font-space-grotesk bg-transparent text-[#5f51ff] border border-[0.5px] border-[rgb(225,227,225)] hover:bg-[#5f51ff] hover:text-white rounded-sm",
        "outline-transparent-secondary":
          "font-space-grotesk bg-transparent text-white border border-[1px] border-outline-transparent-secondary hover:bg-[#5f51ff] hover:text-white rounded-sm",
        secondary:
          "font-space-grotesk bg-white text-[#5f51ff] hover:bg-[#5f51ff] hover:text-white rounded-sm",
        "secondary-dark":
