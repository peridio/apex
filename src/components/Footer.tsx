...
export default function Footer() {
  return (
    <footer className="bg-white text-black font-space-grotesk py-12">
      <div className="max-w-[900px] mx-auto">
        ...
        <div className="grid grid-cols-5 gap-8 mb-8">
          ...
          <div>
            <h4
              className="text-[20px] leading-[1.4em] font-space-grotesk font-normal mb-4"
              style={{ color: "#000" }}
            >
              Sitemap
            </h4>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              <FooterLink
                href="https://docs.peridio.com/platform/reference/overview"
                external
              >
                How Peridio Works
              </FooterLink>
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              ...
              <a
                ...
                className="text-[17px] underline hover:opacity-70 transition-opacity"
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2">
              <FooterLink href="/podcast-beyond-the-bench">
                BTB Podcast
              </FooterLink>
              <FooterLink
                href="https://www.linkedin.com/company/91100454"
                external
              >
                LinkedIn
              </FooterLink>
              ...
              <FooterLink
                href="https://www.youtube.com/@PeridioPlatform"
                external
              >
                Youtube
              </FooterLink>
        ...
        <div className="flex items-center gap-6 text-[17px]">
          ...
          <span className="ml-auto" style={{ color: "rgba(110, 110, 110, 1)" }}>
            © 2025 Peridio
          </span>
        </div>
      </div>
