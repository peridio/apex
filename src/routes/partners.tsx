  ...
  return (
    <section className="relative h-[620px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 text-center">
        <p className="text-[15px] font-bold font-space-grotesk text-peridio-purple-lighter uppercase tracking-wider mb-6">
          PARTNERS
        </p>
        <h1 className="text-[42px] font-bold font-montserrat text-white tracking-[-2px] leading-[1.2] mb-6">
          Let's Build the Future of Firmware Management Together
        </h1>
        <p className="text-[16px] font-normal font-space-grotesk text-white leading-[1.6] mb-10 max-w-[700px] mx-auto">
          Transform how hardware companies scale device operations by joining
          Peridio's partner ecosystem, where industry leaders unite to deliver
          enterprise-grade firmware solutions.
        </p>
...
function WhyPartnerSection() {
  return (
    <section className="pt-24 pb-24 bg-cover bg-center bg-[linear-gradient(rgba(255,255,255,0.85),rgba(255,255,255,0.85)),url(/img/partners/background.jpg)]">
      <div className="max-w-[900px] mx-auto px-4">
        <div className="mb-16">
          <p className="text-[14px] font-space-grotesk text-peridio-purple uppercase tracking-wider mb-4">
            JOIN OUR PARTNER ECOSYSTEM
          </p>
          <h2 className="text-[28px] font-normal font-montserrat text-black tracking-[-2px] leading-[1.2] mb-4">
            Why Partner with Peridio?
          </h2>
          <p className="text-[18px] font-space-grotesk text-gray-700 leading-[1.5]">
            Join the industry leaders transforming how modern hardware companies
            scale. Together, we'll solve the most complex firmware challenges
  ...
  return (
    ...
    >
      <div className="max-w-[900px] mx-auto">
        ...
        <div className="h-[300px] bg-white rounded-lg shadow-lg mb-12 overflow-hidden">
          <div className="flex flex-col lg:flex-row px-8 py-10">
            {/* Left side - Content */}
            <div className="w-[550px]">
              <blockquote className="text-[20px] font-montserrat font-normal text-gray-800 leading-[1.4] mb-4">
                “Peridio's platform, workflows, and expertise vastly reduce
                time-to-market for launching ambitious AIoT applications on i.MX
                product lines.”
              </blockquote>

              <div className="mb-3">
                <VarisciteLogo height={16} />
              </div>

              <div className="flex items-center mb-4">
                <div>
                  <p className="text-[14px] font-space-grotesk text-[#6E6E6E] font-normal">
                    <span className="font-bold">Tal Semo</span>, Managing
                    Director of Sales and Marketing for the Americas
                  </p>
                </div>
              </div>

              <Button variant="outline-transparent-primary" size="sm" asChild>
                <a
            ...
            {/* Right side - Image */}
            <div className="flex-1 flex items-center justify-center translate-x-1/6 rotate-[-10deg]">
              <img
  ...
  return (
    <section className="py-[130px] bg-white relative overflow-hidden">
      ...
      <div className="max-w-[900px] mx-auto px-4 text-center relative z-10">
        ...
        <Button variant="primary" size="xl" className="w-[175px] text-sm">
          Become a Partner
        </Button>
      </div>
    </section>
...
function PartnerStoryCard({
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-6 w-[440px] h-[400px] flex flex-col">
      ...
      <p className="text-[12px] font-space-grotesk text-peridio-purple uppercase tracking-wider mb-4">
        {partnerType}
      </p>

      <h3 className="text-[20px] font-space-grotesk text-black leading-[1.3] mb-4">
        {title}
      </h3>

      <p className="text-[14px] font-space-grotesk text-gray-600 leading-[1.6] mb-6 flex-grow">
        {description}
      </p>
...
function PartnerBenefitCard({
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm border border-gray-100">
      <div
        className="h-[120px] pl-6 pr-10 flex items-center justify-between"
        style={{
          background:
            "linear-gradient(270deg, #5F51FF 0%, #000000 60.97519188596491%)",
        }}
      >
        <h3 className="text-[22px] font-bold font-montserrat text-white leading-[1.3] max-w-[60%]">
          {title}
        </h3>
        {icon}
      </div>
      ...
      <div className="p-8">
        <p className="text-[14px] text-[#6E6E6E] font-space-grotesk leading-[1.6]">
          {description}
        </p>
      </div>
    </div>
  ...
  return (
    ...
    >
      <g>
        ...
        <path
          fill="currentColor"
          d="M22.236 27.432h-1.401v-1.433h1.401z"
        ></path>
        <path
          fill="currentColor"
          d="M25.203 25.992v1.418h-1.426v-1.418z"
        ></path>
      </g>
    </svg>
  );
