...
const HS_FORM_ID = 'contact-form'

function RouteComponent() {
  useHubspotForm('2ea292ec-5737-40f3-be74-664eb6dcb1e7', HS_FORM_ID)
        ...
        <div className="relative z-10 mx-auto max-w-[900px] px-4 pt-28 lg:pt-40">
          <div className="mb-6 text-center">
            ...
            <p className="font-montserrat mx-auto max-w-[350px] text-[16px] font-normal text-white lg:max-w-2xl">
              Let a member of our team show you how Peridio you can improve your device management
              strategies and development toolchain.
            </p>
          </div>
