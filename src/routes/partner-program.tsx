...
const HS_FORM_ID = 'partner-program-form'

function Page() {
  useHubspotForm('fcc94035-5cb1-4d45-965c-f32f09d28adf', HS_FORM_ID)
      ...
      <div className="relative text-white">
        ...
        <div className="relative z-10 mx-auto max-w-[900px] px-4 pt-28 pb-16 lg:pt-40 lg:pb-20">
          <div className="text-center">
            <h1 className="font-montserrat mx-auto mb-6 max-w-[350px] text-[34px] leading-10 font-[700] tracking-[-1.4px] md:text-[40px] lg:max-w-[615px] lg:text-[46px] lg:leading-[77px]">
              Partner with Peridio
            </h1>
            <p className="font-montserrat mx-auto max-w-[350px] text-[16px] font-normal text-white">
              Join the industry leaders transforming how modern hardware companies scale.
            </p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        >
          <div className="mx-auto max-w-[900px] py-16">
            <div
              id={HS_FORM_ID}
              className="mx-auto h-[840px] w-[400px] rounded-2xl bg-white p-8 shadow-lg md:h-[750px] md:w-[630px]"
            />
          </div>
        </div>
      </div>
