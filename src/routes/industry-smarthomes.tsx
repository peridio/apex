  ...
  return (
    <div className="min-h-screen bg-white">
      <IndustryTopHeroSection
        smallHeader="SMART HOMES"
        headline="Transform Smart Home Operations"
        description="Peridio empowers smart home manufacturers to operationalize firmware management across connected devices and home automation systems."
