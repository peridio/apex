  ...
  return (
    <div className="bg-black">
      ...
      >
        ...
        />
        {/* Header Section */}
        <div className="max-w-[900px] mx-auto px-4 h-[550px] pt-40 text-white relative z-10">
          <div className="text-center mb-6">
            <h1 className="font-montserrat text-[70px] font-[700] w-[615px] mx-auto mb-8 leading-[77px] tracking-[-1.4px]">
              See it for yourself with a free demo
            </h1>
            <p className="font-space-grotesk text-[16px] font-normal text-white mx-auto tracking-[0.8px]">
